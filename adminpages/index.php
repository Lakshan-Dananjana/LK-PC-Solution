...
<head>
    ...
    <title>Admin Login|LK PC Solution|Dambulla</title>
    ...
    <div class="container_login">
        <form action="" method="post" class="login">
            ...
            <div class="adminUserName">
                <input type="text" name="adminUsreName" id="adminUserName" placeholder="Admin User Name">
            </div>
            <div class="adminPwd">
                <input type="password" name="adminPwd" id="adminPwd" placeholder="Admin Password">
                <div class="icon">
